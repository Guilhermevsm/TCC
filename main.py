...
def janela_funcionarios():
    ...
    my_tree.column("Nome", width=400, anchor=CENTER)
    my_tree.column("Telefone", width=150, anchor=CENTER)
    my_tree.column("Endereço", width=500, anchor=CENTER)
...
def janela_transacao():
    ...
    #adicionando as caixas de entrada
    data_frame = LabelFrame(root, text="Transações")
    data_frame.pack(fill="x", expand="yes", padx=20)
    ...
    f_id_transacao_label = Label(data_frame, text="CNPJ Fornecedor")
